...
class ProductEvidenceLogger:
    
    def __init__(self, test_suite_name,base_url):
        self.test_suite_name = test_suite_name
        self.base_url = base_url
        self.evidence_dir = "product-service/products_tests/products_evidence"
